...
instance ToJSON Rule where
  toJSON (Seq members) = object ["type" .= ("SEQ" :: String), "members" .= members]
  toJSON (Choice members) = object ["type" .= ("CHOICE" :: String), "members" .= members]
  toJSON (Repeat content) = object ["type" .= ("REPEAT" :: String), "content" .= content]
  toJSON (Repeat1 content) = object ["type" .= ("REPEAT1" :: String), "content" .= content]
  toJSON (Symbol name) = object ["type" .= ("SYMBOL" :: String), "name" .= name]
  toJSON (StringLit value) = object ["type" .= ("STRING" :: String), "value" .= value]
  toJSON (Pattern value) = object ["type" .= ("PATTERN" :: String), "value" .= value]
  toJSON Blank = object ["type" .= ("BLANK" :: String)]
  toJSON (Field fieldName content) = object ["type" .= ("FIELD" :: String), "name" .= fieldName, "content" .= content]
  toJSON (Alias content named aliasValue) = object ["type" .= ("ALIAS" :: String), "content" .= content, "named" .= named, "value" .= aliasValue]
  toJSON (Token content) = object ["type" .= ("TOKEN" :: String), "content" .= content]
  toJSON (ImmediateToken content) = object ["type" .= ("IMMEDIATE_TOKEN" :: String), "content" .= content]
  toJSON (Prec precedence content) = object ["type" .= ("PREC" :: String), "value" .= precedence, "content" .= content]
  toJSON (PrecLeft precedence content) = object ["type" .= ("PREC_LEFT" :: String), "value" .= precedence, "content" .= content]
  toJSON (PrecRight precedence content) = object ["type" .= ("PREC_RIGHT" :: String), "value" .= precedence, "content" .= content]
  toJSON (PrecDynamic precedence content) = object ["type" .= ("PREC_DYNAMIC" :: String), "value" .= precedence, "content" .= content]
  toJSON (Reserved content contextName) = object ["type" .= ("RESERVED" :: String), "content" .= content, "context_name" .= contextName]
...
instance ToJSON Grammar where
  toJSON (Grammar name word rules) = object $
    [ "name" .= name
    , "rules" .= rules
    ] ++ maybe [] (\w -> ["word" .= w]) word
