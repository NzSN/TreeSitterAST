...
export class _jsx_string_0_T extends _jsx_string_T { unescaped_double_jsx_string_fragment_0_i : Unescaped_double_jsx_string_fragment_T | undefined;
 ...
 constructor(unescaped_double_jsx_string_fragment_0 : Unescaped_double_jsx_string_fragment_T | undefined,html_character_reference_1 : Html_character_reference_T | undefined) { super();this.unescaped_double_jsx_string_fragment_0_i = unescaped_double_jsx_string_fragment_0;this.html_character_reference_1_i = html_character_reference_1; } evaluate(): string { return `\"${(() => { if (this.unescaped_double_jsx_string_fragment_0_i !== undefined) { return this.unescaped_double_jsx_string_fragment_0_i.evaluate(); } if (this.html_character_reference_1_i !== undefined) { return this.html_character_reference_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}\"`; } }
export class _jsx_string_1_T extends _jsx_string_T { unescaped_single_jsx_string_fragment_0_i : Unescaped_single_jsx_string_fragment_T | undefined;
 html_character_reference_1_i : Html_character_reference_T | undefined;
 constructor(unescaped_single_jsx_string_fragment_0 : Unescaped_single_jsx_string_fragment_T | undefined,html_character_reference_1 : Html_character_reference_T | undefined) { super();this.unescaped_single_jsx_string_fragment_0_i = unescaped_single_jsx_string_fragment_0;this.html_character_reference_1_i = html_character_reference_1; } evaluate(): string { return `'${(() => { if (this.unescaped_single_jsx_string_fragment_0_i !== undefined) { return this.unescaped_single_jsx_string_fragment_0_i.evaluate(); } if (this.html_character_reference_1_i !== undefined) { return this.html_character_reference_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}'`; } }
...
export class Arrow_function_T extends SyntaticInterior { _reserved_identifier_0_i : _reserved_identifier_T | undefined;
 ...
 constructor(_reserved_identifier_0 : _reserved_identifier_T | undefined,identifier_1 : Identifier_T | undefined,_call_signature_2 : _call_signature_T | undefined,expression_3 : Expression_T | undefined,statement_block_4 : Statement_block_T | undefined) { super();this._reserved_identifier_0_i = _reserved_identifier_0;this.identifier_1_i = identifier_1;this._call_signature_2_i = _call_signature_2;this.expression_3_i = expression_3;this.statement_block_4_i = statement_block_4; } evaluate(): string { return `${(() => { return "async"; })()}${(() => { if (this._reserved_identifier_0_i !== undefined) { return this._reserved_identifier_0_i.evaluate(); } if (this._call_signature_2_i !== undefined) { return this._call_signature_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}=>${(() => { if (this.expression_3_i !== undefined) { return this.expression_3_i.evaluate(); } if (this.statement_block_4_i !== undefined) { return this.statement_block_4_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}`; } }
...
export class Augmented_assignment_expression_T extends SyntaticInterior { _augmented_assignment_lhs_0_i : _augmented_assignment_lhs_T;
 expression_1_i : Expression_T;
 constructor(_augmented_assignment_lhs_0 : _augmented_assignment_lhs_T,expression_1 : Expression_T) { super();this._augmented_assignment_lhs_0_i = _augmented_assignment_lhs_0;this.expression_1_i = expression_1; } evaluate(): string { return `${this._augmented_assignment_lhs_0_i.evaluate()}${(() => { return "+="; })()}${this.expression_1_i.evaluate()}`; } }
...
export class Break_statement_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 ...
 constructor(identifier_0 : Identifier_T | undefined,_semicolon_1 : _semicolon_T) { super();this.identifier_0_i = identifier_0;this._semicolon_1_i = _semicolon_1; } evaluate(): string { return `break${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } return ""; })()}${this._semicolon_1_i.evaluate()}`; } }
...
export class Call_expression_call_T extends Call_expression_T { expression_0_i : Expression_T | undefined;
 ...
 constructor(expression_0 : Expression_T | undefined,import_1 : Import_T | undefined,arguments_2 : Arguments_T) { super();this.expression_0_i = expression_0;this.import_1_i = import_1;this.arguments_2_i = arguments_2; } evaluate(): string { return `${(() => { if (this.expression_0_i !== undefined) { return this.expression_0_i.evaluate(); } if (this.import_1_i !== undefined) { return this.import_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${this.arguments_2_i.evaluate()}`; } }
...
export class Call_expression_template_call_T extends Call_expression_T { primary_expression_0_i : Primary_expression_T | undefined;
 ...
 constructor(primary_expression_0 : Primary_expression_T | undefined,new_expression_1 : New_expression_T | undefined,template_string_2 : Template_string_T) { super();this.primary_expression_0_i = primary_expression_0;this.new_expression_1_i = new_expression_1;this.template_string_2_i = template_string_2; } evaluate(): string { return `${(() => { if (this.primary_expression_0_i !== undefined) { return this.primary_expression_0_i.evaluate(); } if (this.new_expression_1_i !== undefined) { return this.new_expression_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${this.template_string_2_i.evaluate()}`; } }
export class Catch_clause_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 ...
 constructor(identifier_0 : Identifier_T | undefined,_destructuring_pattern_1 : _destructuring_pattern_T | undefined,statement_block_2 : Statement_block_T) { super();this.identifier_0_i = identifier_0;this._destructuring_pattern_1_i = _destructuring_pattern_1;this.statement_block_2_i = statement_block_2; } evaluate(): string { return `catch${(() => { if (this.identifier_0_i !== undefined) { return `(${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } if (this._destructuring_pattern_1_i !== undefined) { return this._destructuring_pattern_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()})`; } return ""; })()}${this.statement_block_2_i.evaluate()}`; } }
...
export class Continue_statement_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 _semicolon_1_i : _semicolon_T;
 constructor(identifier_0 : Identifier_T | undefined,_semicolon_1 : _semicolon_T) { super();this.identifier_0_i = identifier_0;this._semicolon_1_i = _semicolon_1; } evaluate(): string { return `continue${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } return ""; })()}${this._semicolon_1_i.evaluate()}`; } }
...
export class Decorator_member_expression_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 ...
 constructor(identifier_0 : Identifier_T | undefined,decorator_member_expression_1 : Decorator_member_expression_T | undefined,identifier_2 : Identifier_T) { super();this.identifier_0_i = identifier_0;this.decorator_member_expression_1_i = decorator_member_expression_1;this.identifier_2_i = identifier_2; } evaluate(): string { return `${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } if (this.decorator_member_expression_1_i !== undefined) { return this.decorator_member_expression_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}.${this.identifier_2_i.evaluate()}`; } }
...
export class Export_specifier_T extends SyntaticInterior { _module_export_name_0_i : _module_export_name_T;
 ...
 constructor(_module_export_name_0 : _module_export_name_T,_module_export_name_1 : _module_export_name_T | undefined) { super();this._module_export_name_0_i = _module_export_name_0;this._module_export_name_1_i = _module_export_name_1; } evaluate(): string { return `${this._module_export_name_0_i.evaluate()}${(() => { if (this._module_export_name_1_i !== undefined) { return `as${this._module_export_name_1_i.evaluate()}`; } return ""; })()}`; } }
...
export class Export_statement_0_T extends Export_statement_T { _from_clause_0_i : _from_clause_T | undefined;
 ...
 constructor(_from_clause_0 : _from_clause_T | undefined,namespace_export_1 : Namespace_export_T | undefined,_from_clause_2 : _from_clause_T | undefined,export_clause_3 : Export_clause_T | undefined,_from_clause_4 : _from_clause_T | undefined,export_clause_5 : Export_clause_T | undefined,_semicolon_6 : _semicolon_T) { super();this._from_clause_0_i = _from_clause_0;this.namespace_export_1_i = namespace_export_1;this._from_clause_2_i = _from_clause_2;this.export_clause_3_i = export_clause_3;this._from_clause_4_i = _from_clause_4;this.export_clause_5_i = export_clause_5;this._semicolon_6_i = _semicolon_6; } evaluate(): string { return `export${(() => { if (this._from_clause_0_i !== undefined) { return `*${this._from_clause_0_i.evaluate()}`; } if (this.namespace_export_1_i !== undefined) { return `${this.namespace_export_1_i.evaluate()}${this._from_clause_2_i.evaluate()}`; } if (this.export_clause_3_i !== undefined) { return `${this.export_clause_3_i.evaluate()}${this._from_clause_4_i.evaluate()}`; } if (this.export_clause_5_i !== undefined) { return this.export_clause_5_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${this._semicolon_6_i.evaluate()}`; } }
...
export class For_in_statement_T extends SyntaticInterior { _for_header_0_i : _for_header_T;
 ...
 constructor(_for_header_0 : _for_header_T,statement_1 : Statement_T) { super();this._for_header_0_i = _for_header_0;this.statement_1_i = statement_1; } evaluate(): string { return `for${(() => { return "await"; })()}${this._for_header_0_i.evaluate()}${this.statement_1_i.evaluate()}`; } }
export class For_statement_T extends SyntaticInterior { lexical_declaration_0_i : Lexical_declaration_T | undefined;
 ...
 constructor(lexical_declaration_0 : Lexical_declaration_T | undefined,variable_declaration_1 : Variable_declaration_T | undefined,_expressions_2 : _expressions_T | undefined,empty_statement_3 : Empty_statement_T | undefined,_expressions_4 : _expressions_T | undefined,empty_statement_5 : Empty_statement_T | undefined,_expressions_6 : _expressions_T | undefined,statement_7 : Statement_T) { super();this.lexical_declaration_0_i = lexical_declaration_0;this.variable_declaration_1_i = variable_declaration_1;this._expressions_2_i = _expressions_2;this.empty_statement_3_i = empty_statement_3;this._expressions_4_i = _expressions_4;this.empty_statement_5_i = empty_statement_5;this._expressions_6_i = _expressions_6;this.statement_7_i = statement_7; } evaluate(): string { return `for(${(() => { if (this.lexical_declaration_0_i !== undefined) { return this.lexical_declaration_0_i.evaluate(); } if (this._expressions_2_i !== undefined) { return `${this._expressions_2_i.evaluate()};`; } if (this.empty_statement_3_i !== undefined) { return this.empty_statement_3_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${(() => { if (this._expressions_4_i !== undefined) { return `${this._expressions_4_i.evaluate()};`; } if (this.empty_statement_5_i !== undefined) { return this.empty_statement_5_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${(() => { if (this._expressions_6_i !== undefined) { return this._expressions_6_i.evaluate(); } return ""; })()})${this.statement_7_i.evaluate()}`; } }
export class Formal_parameters_T extends SyntaticInterior { _formal_parameter_0_i : _formal_parameter_T | undefined;
 ...
 constructor(_formal_parameter_0 : _formal_parameter_T | undefined,_formal_parameter_1 : _formal_parameter_T | undefined) { super();this._formal_parameter_0_i = _formal_parameter_0;this._formal_parameter_1_i = _formal_parameter_1; } evaluate(): string { return `(${(() => { if (this._formal_parameter_0_i !== undefined) { return `${`${this._formal_parameter_0_i.evaluate()}${`,${this._formal_parameter_1_i.evaluate()}`}`}${(() => { return ","; })()}`; } return ""; })()})`; } }
...
export class Function_expression_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 _call_signature_1_i : _call_signature_T;
 statement_block_2_i : Statement_block_T;
 constructor(identifier_0 : Identifier_T | undefined,_call_signature_1 : _call_signature_T,statement_block_2 : Statement_block_T) { super();this.identifier_0_i = identifier_0;this._call_signature_1_i = _call_signature_1;this.statement_block_2_i = statement_block_2; } evaluate(): string { return `${(() => { return "async"; })()}function${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } return ""; })()}${this._call_signature_1_i.evaluate()}${this.statement_block_2_i.evaluate()}`; } }
...
export class Import_clause_2_T extends Import_clause_T { identifier_0_i : Identifier_T;
 ...
 constructor(identifier_0 : Identifier_T,namespace_import_1 : Namespace_import_T | undefined,named_imports_2 : Named_imports_T | undefined) { super();this.identifier_0_i = identifier_0;this.namespace_import_1_i = namespace_import_1;this.named_imports_2_i = named_imports_2; } evaluate(): string { return `${this.identifier_0_i.evaluate()}${(() => { if (this.namespace_import_1_i !== undefined) { return `,${(() => { if (this.namespace_import_1_i !== undefined) { return this.namespace_import_1_i.evaluate(); } if (this.named_imports_2_i !== undefined) { return this.named_imports_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}`; } return ""; })()}`; } }
...
export class Import_statement_T extends SyntaticInterior { import_clause_0_i : Import_clause_T | undefined;
 ...
 constructor(import_clause_0 : Import_clause_T | undefined,_from_clause_1 : _from_clause_T | undefined,string_2 : String_T | undefined,import_attribute_3 : Import_attribute_T | undefined,_semicolon_4 : _semicolon_T) { super();this.import_clause_0_i = import_clause_0;this._from_clause_1_i = _from_clause_1;this.string_2_i = string_2;this.import_attribute_3_i = import_attribute_3;this._semicolon_4_i = _semicolon_4; } evaluate(): string { return `import${(() => { if (this.import_clause_0_i !== undefined) { return `${this.import_clause_0_i.evaluate()}${this._from_clause_1_i.evaluate()}`; } if (this.string_2_i !== undefined) { return this.string_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${(() => { if (this.import_attribute_3_i !== undefined) { return this.import_attribute_3_i.evaluate(); } return ""; })()}${this._semicolon_4_i.evaluate()}`; } }
export class Jsx_attribute_T extends SyntaticInterior { _jsx_attribute_name_0_i : _jsx_attribute_name_T;
 ...
 constructor(_jsx_attribute_name_0 : _jsx_attribute_name_T,_jsx_attribute_value_1 : _jsx_attribute_value_T | undefined) { super();this._jsx_attribute_name_0_i = _jsx_attribute_name_0;this._jsx_attribute_value_1_i = _jsx_attribute_value_1; } evaluate(): string { return `${this._jsx_attribute_name_0_i.evaluate()}${(() => { if (this._jsx_attribute_value_1_i !== undefined) { return `=${this._jsx_attribute_value_1_i.evaluate()}`; } return ""; })()}`; } }
export class Jsx_closing_element_T extends SyntaticInterior { _jsx_element_name_0_i : _jsx_element_name_T | undefined;
 constructor(_jsx_element_name_0 : _jsx_element_name_T | undefined) { super();this._jsx_element_name_0_i = _jsx_element_name_0; } evaluate(): string { return `</${(() => { if (this._jsx_element_name_0_i !== undefined) { return this._jsx_element_name_0_i.evaluate(); } return ""; })()}>`; } }
...
export class Jsx_opening_element_T extends SyntaticInterior { _jsx_element_name_0_i : _jsx_element_name_T | undefined;
 ...
 constructor(_jsx_element_name_0 : _jsx_element_name_T | undefined,_jsx_attribute_1 : _jsx_attribute_T | undefined) { super();this._jsx_element_name_0_i = _jsx_element_name_0;this._jsx_attribute_1_i = _jsx_attribute_1; } evaluate(): string { return `<${(() => { if (this._jsx_element_name_0_i !== undefined) { return `${this._jsx_element_name_0_i.evaluate()}${this._jsx_attribute_1_i.evaluate()}`; } return ""; })()}>`; } }
...
export class Labeled_statement_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 ...
 constructor(identifier_0 : Identifier_T | undefined,_reserved_identifier_1 : _reserved_identifier_T | undefined,statement_2 : Statement_T) { super();this.identifier_0_i = identifier_0;this._reserved_identifier_1_i = _reserved_identifier_1;this.statement_2_i = statement_2; } evaluate(): string { return `${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } if (this._reserved_identifier_1_i !== undefined) { return this._reserved_identifier_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}:${this.statement_2_i.evaluate()}`; } }
...
export class Member_expression_T extends SyntaticInterior { expression_0_i : Expression_T | undefined;
 ...
 identifier_5_i : Identifier_T | undefined;
 constructor(expression_0 : Expression_T | undefined,primary_expression_1 : Primary_expression_T | undefined,import_2 : Import_T | undefined,optional_chain_3 : Optional_chain_T | undefined,private_property_identifier_4 : Private_property_identifier_T | undefined,identifier_5 : Identifier_T | undefined) { super();this.expression_0_i = expression_0;this.primary_expression_1_i = primary_expression_1;this.import_2_i = import_2;this.optional_chain_3_i = optional_chain_3;this.private_property_identifier_4_i = private_property_identifier_4;this.identifier_5_i = identifier_5; } evaluate(): string { return `${(() => { if (this.expression_0_i !== undefined) { return this.expression_0_i.evaluate(); } if (this.primary_expression_1_i !== undefined) { return this.primary_expression_1_i.evaluate(); } if (this.import_2_i !== undefined) { return this.import_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}${(() => { return "."; })()}${(() => { if (this.private_property_identifier_4_i !== undefined) { return this.private_property_identifier_4_i.evaluate(); } if (this.identifier_5_i !== undefined) { return this.identifier_5_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}`; } }
...
export class Named_imports_T extends SyntaticInterior { import_specifier_0_i : Import_specifier_T | undefined;
 ...
 constructor(import_specifier_0 : Import_specifier_T | undefined,import_specifier_1 : Import_specifier_T | undefined) { super();this.import_specifier_0_i = import_specifier_0;this.import_specifier_1_i = import_specifier_1; } evaluate(): string { return `{${(() => { if (this.import_specifier_0_i !== undefined) { return `${this.import_specifier_0_i.evaluate()}${`,${this.import_specifier_1_i.evaluate()}`}`; } return ""; })()}${(() => { return ","; })()}}`; } }
...
export class Nested_identifier_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 ...
 identifier_2_i : Identifier_T;
 constructor(identifier_0 : Identifier_T | undefined,nested_identifier_1 : Nested_identifier_T | undefined,identifier_2 : Identifier_T) { super();this.identifier_0_i = identifier_0;this.nested_identifier_1_i = nested_identifier_1;this.identifier_2_i = identifier_2; } evaluate(): string { return `${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } if (this.nested_identifier_1_i !== undefined) { return this.nested_identifier_1_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}.${this.identifier_2_i.evaluate()}`; } }
...
export class Object_assignment_pattern_T extends SyntaticInterior { _reserved_identifier_0_i : _reserved_identifier_T | undefined;
 ...
 constructor(_reserved_identifier_0 : _reserved_identifier_T | undefined,identifier_1 : Identifier_T | undefined,_destructuring_pattern_2 : _destructuring_pattern_T | undefined,expression_3 : Expression_T) { super();this._reserved_identifier_0_i = _reserved_identifier_0;this.identifier_1_i = identifier_1;this._destructuring_pattern_2_i = _destructuring_pattern_2;this.expression_3_i = expression_3; } evaluate(): string { return `${(() => { if (this._reserved_identifier_0_i !== undefined) { return this._reserved_identifier_0_i.evaluate(); } if (this._destructuring_pattern_2_i !== undefined) { return this._destructuring_pattern_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}=${this.expression_3_i.evaluate()}`; } }
...
export class Pair_pattern_T extends SyntaticInterior { _property_name_0_i : _property_name_T;
 ...
 constructor(_property_name_0 : _property_name_T,pattern_1 : Pattern_T | undefined,assignment_pattern_2 : Assignment_pattern_T | undefined) { super();this._property_name_0_i = _property_name_0;this.pattern_1_i = pattern_1;this.assignment_pattern_2_i = assignment_pattern_2; } evaluate(): string { return `${this._property_name_0_i.evaluate()}:${(() => { if (this.pattern_1_i !== undefined) { return this.pattern_1_i.evaluate(); } if (this.assignment_pattern_2_i !== undefined) { return this.assignment_pattern_2_i.evaluate(); } throw new Error("No alternative matched in CHOICE node"); })()}`; } }
...
export class Return_statement_T extends SyntaticInterior { _expressions_0_i : _expressions_T | undefined;
 _semicolon_1_i : _semicolon_T;
 constructor(_expressions_0 : _expressions_T | undefined,_semicolon_1 : _semicolon_T) { super();this._expressions_0_i = _expressions_0;this._semicolon_1_i = _semicolon_1; } evaluate(): string { return `return${(() => { if (this._expressions_0_i !== undefined) { return this._expressions_0_i.evaluate(); } return ""; })()}${this._semicolon_1_i.evaluate()}`; } }
...
export class Statement_block_T extends Statement_T { statement_0_i : Statement_T;
 constructor(statement_0 : Statement_T) { super();this.statement_0_i = statement_0; } evaluate(): string { return `{${this.statement_0_i.evaluate()}}${(() => { return ""; })()}`; } }
...
export class String_0_T extends String_T { unescaped_double_string_fragment_0_i : Unescaped_double_string_fragment_T | undefined;
 constructor(unescaped_double_string_fragment_0 : Unescaped_double_string_fragment_T | undefined) { super();this.unescaped_double_string_fragment_0_i = unescaped_double_string_fragment_0; } evaluate(): string { return `\"${(() => { if (this.unescaped_double_string_fragment_0_i !== undefined) { return this.unescaped_double_string_fragment_0_i.evaluate(); } return ""; })()}\"`; } }
export class String_1_T extends String_T { unescaped_single_string_fragment_0_i : Unescaped_single_string_fragment_T | undefined;
 constructor(unescaped_single_string_fragment_0 : Unescaped_single_string_fragment_T | undefined) { super();this.unescaped_single_string_fragment_0_i = unescaped_single_string_fragment_0; } evaluate(): string { return `'${(() => { if (this.unescaped_single_string_fragment_0_i !== undefined) { return this.unescaped_single_string_fragment_0_i.evaluate(); } return ""; })()}'`; } }
...
export class Template_string_T extends SyntaticInterior { template_substitution_0_i : Template_substitution_T | undefined;
 constructor(template_substitution_0 : Template_substitution_T | undefined) { super();this.template_substitution_0_i = template_substitution_0; } evaluate(): string { return "`" + (() => { return ""; })() + "`"; } }
...
export class Using_declaration_T extends SyntaticInterior { variable_declarator_0_i : Variable_declarator_T;
 variable_declarator_1_i : Variable_declarator_T;
 _semicolon_2_i : _semicolon_T;
 constructor(variable_declarator_0 : Variable_declarator_T,variable_declarator_1 : Variable_declarator_T,_semicolon_2 : _semicolon_T) { super();this.variable_declarator_0_i = variable_declarator_0;this.variable_declarator_1_i = variable_declarator_1;this._semicolon_2_i = _semicolon_2; } evaluate(): string { return `${(() => { return "using"; })()}${`${this.variable_declarator_0_i.evaluate()}${`,${this.variable_declarator_1_i.evaluate()}`}`}${this._semicolon_2_i.evaluate()}`; } }
...
export class Variable_declarator_T extends SyntaticInterior { identifier_0_i : Identifier_T | undefined;
 _destructuring_pattern_1_i : _destructuring_pattern_T | undefined;
 _initializer_2_i : _initializer_T | undefined;
 constructor(identifier_0 : Identifier_T | undefined,_destructuring_pattern_1 : _destructuring_pattern_T | undefined,_initializer_2 : _initializer_T | undefined) { super();this.identifier_0_i = identifier_0;this._destructuring_pattern_1_i = _destructuring_pattern_1;this._initializer_2_i = _initializer_2; } evaluate(): string { return `${(() => { if (this.identifier_0_i !== undefined) { return this.identifier_0_i.evaluate(); } return "of"; })()}${(() => { if (this._initializer_2_i !== undefined) { return this._initializer_2_i.evaluate(); } return ""; })()}`; } }
