...
## Rules of agents working on this repository (Edit by AGENT is not allowed)
- All files generated by agent should be place at directory
  'agent_generated' under root.
- All working by agents should be record in files (in format as work_YYYYMMMM_HHMMSS.md) in directory agent/works, directory 'agent' is at root of this project.
